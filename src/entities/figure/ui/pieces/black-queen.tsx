...
export function BlackQueen({ width = 45, height = 45 }: BlackQueenProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 45 45">
      <G fill="#000000" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <Path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38.5,13.5 L 31,25 L 30.7,10.9 L 25.5,24.5 L 22.5,10 L 19.5,24.5 L 14.3,10.9 L 14,25 L 6.5,13.5 L 9,26 z" strokeLinecap="butt" fill="#000000" />
