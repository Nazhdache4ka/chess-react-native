...
export function BlackRook({ width = 45, height = 45 }: BlackRookProps) {
  return (
    <Svg width={width} height={height} viewBox="0 0 45 45">
      <G
        ...
        <Path d="M 12,35.5 L 33,35.5 L 33,35.5" fill="none" stroke="#ffffff" strokeWidth="1" strokeLinejoin="miter" />
        <Path d="M 13,31.5 L 32,31.5" fill="none" stroke="#ffffff" strokeWidth="1" strokeLinejoin="miter" />
        <Path d="M 14,29.5 L 31,29.5" fill="none" stroke="#ffffff" strokeWidth="1" strokeLinejoin="miter" />
        <Path d="M 14,16.5 L 31,16.5" fill="none" stroke="#ffffff" strokeWidth="1" strokeLinejoin="miter" />
